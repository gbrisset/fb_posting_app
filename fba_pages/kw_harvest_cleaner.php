...
$parfba_kh['kh_passed_black_list'] = 0; 
$parfba_kh['kh_char_clean_up'] = 0; 
$parfba_kh['kh_char_count'] = 0; 
$parfba_kh['kh_word_count'] = 0; 

$kw_harvest_raw = $fba_utilities->sql_get_all_rows($query_kh, $parfba_kh);
...
// $fba_utilities->better_vardump($kw_harvest_raw[$khr_key],2);// 0- green; 1-red; 2-grey; 3-yellow   
...
// $fba_utilities->better_vardump($kw_harvest_raw[$khr_key],3);// 0- green; 1-red; 2-grey; 3-yellow   
...
$fba_utilities->better_vardump("<br>Clean up  done",0);// 0- green; 1-red; 2-grey; 3-yellow   
...
# ---------------------------------------------------------------
	...
	$kw_black_list = $fba_utilities->sql_get_all_rows($query_kbl, $parfba_kbl);
...
$fba_utilities->better_vardump("<br>Black List challenge  done",2);// 0- green; 1-red; 2-grey; 3-yellow   

//VARDUMP //VARDUMP //VARDUMP //VARDUMP //VARDUMP //VARDUMP //VARDUMP //VARDUMP //VARDUMP //VARDUMP //VARDUMP //VARDUMP //VARDUMP //VARDUMP 
// $fba_utilities->better_vardump($kw_harvest_raw,2);// 0- green; 1-red; 2-grey; 3-yellow   
// exit();
...
// 	$parfba_khr['kh_keyword_text'] = $kw_harvest_raw[$khr_key]['kh_keyword_text'];
// 	$parfba_khr['kh_keyword_author'] = $kw_harvest_raw[$khr_key]['kh_keyword_author'];
// 	$parfba_khr['kh_passed_black_list'] = $kw_harvest_raw[$khr_key]['kh_passed_black_list'];
// 	$parfba_khr['kh_char_clean_up'] = $kw_harvest_raw[$khr_key]['kh_char_clean_up'];
// 	$parfba_khr['kh_char_count'] = $kw_harvest_raw[$khr_key]['kh_char_count'];
// 	$parfba_khr['kh_word_count'] = $kw_harvest_raw[$khr_key]['kh_word_count'];
// 	$parfba_khr['kh_id'] = $kw_harvest_raw[$khr_key]['kh_id'];

// 	$fba_utilities->sql_execute($query_khr, $parfba_khr);
...
$fba_utilities->better_vardump("<br>Update datebase  done",0);// 0- green; 1-red; 2-grey; 3-yellow   
